...
# 1.3 Почему количество документов меньше количества вхождений? Ответ: в одном докуенте может быть несколько вхождений
```
### 2. IPM
...
```
# 2.1 Значение IPM: примерно 0,444
```
...
```
# 7.1 Прилагательные: белый, пшеничный, красный
```
